...
if ($action === 'add' || $action === 'update') {
    ...
    if ($action === 'add') {
        ...
        $career = fetchRow("SELECT * FROM career_history WHERE career_id = ? AND user_id = ?", 'ii', [$id, $user['user_id']]);
        ...
        $updated = updateData('career_history', $careerData, 'career_id', $id);
    ...
    // Delete the record
    $deleted = deleteData('career_history', 'career_id', $id);
