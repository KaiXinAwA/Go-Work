<!-- This is a new file with the updated view_user.php structure that moves license information to a separate card -->
<?php
$pageTitle = 'View User';
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <!-- License Information (for Companies) - Now in a separate card -->
            <div class="card mb-4">
                <div class="card-header">
