                                    ...
                                    <tbody>
                                        <?php foreach ($pendingLicenses as $license): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo SITE_URL; ?>/pages/admin/review_license.php?id=<?php echo $license['company_id']; ?>" class="btn btn-primary btn-sm">Review</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($status !== 'Approved' && $status !== 'Not Approved') {
        ...
        redirectTo(SITE_URL . '/pages/admin/review_license.php?id=' . $companyId);
    }
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo SITE_URL; ?>">Home</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo SITE_URL; ?>/pages/admin/dashboard.php">Admin Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo SITE_URL; ?>/pages/admin/review_license.php">Review Licenses</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo SITE_URL; ?>/pages/admin/review_license.php?id=<?php echo $companyId; ?>" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo SITE_URL; ?>/pages/admin/review_license.php" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
